...
const CANCELLATION_BASE = '/experience/product/cancellation-policy';
// GET
const getCancelationPolicies = (experience_id) => {
    return TravelDashboardAPI.get(CANCELLATION_BASE + `/list/${experience_id}`).then((res) => {
...
const getCancelationPoliciesTypes = () => {
    return TravelDashboardAPI.get("/common/list-cancellation-policy-types").then((res) => {
        return res.data.data;
    }).catch((error) => {
        throw new Error(responseErrorMessageExtractor(error));
    })
...
const getCancelationPoliciesPeriodTypes = () => {
    return TravelDashboardAPI.get("/common/list-cancellation-policy-period-types").then((res) => {
        return res.data.data;
    }).catch((error) => {
        throw new Error(responseErrorMessageExtractor(error));
    })
...
const getCancelationPoliciesDateRangeTypes = () => {
    return TravelDashboardAPI.get("/common/list-cancellation-policy-date-range").then((res) => {
        return res.data.data;
    }).catch((error) => {
        throw new Error(responseErrorMessageExtractor(error));
    })
...
const CancelationPolicyService = {
...
export default CancelationPolicyService;
