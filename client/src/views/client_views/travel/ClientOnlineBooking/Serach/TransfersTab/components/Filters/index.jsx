...
// API CALLS
import useGetVehicleBrandsClient from 'services/travel/client_side/booking/transfer/Queries/useGetVehicleBrandsClient';
import useGetVehicleTypesClient from 'services/travel/client_side/booking/transfer/Queries/useGetVehicleTypesClient';
// styles
import './styles.css';
...
const Filters = ({ center, directions, setFilterdResults, results }) => {
    const vehicleBrands = useGetVehicleBrandsClient();
    const vehicleTypes = useGetVehicleTypesClient();
