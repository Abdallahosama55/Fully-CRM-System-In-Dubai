...
import useBookTransferClient from "services/travel/client_side/booking/transfer/Mutations/useBookTransferClient";
import useGetTransferById from "services/travel/client_side/booking/transfer/Queries/useGetTransferById";

const BookTransferClient = () => {
  ...
  // API CALLS
  const vehicleById = useGetTransferById(id, { enabled: !!id });
  // MUTATIONS
  const bookTransfer = useBookTransferClient({
    onSuccess: () => {
...
export default BookTransferClient;
