...
import useGetTurboEngineExperiences from "services/travel/packages/turboEngine/Queries/useGetTurboEngineExperiences";
import empty_booking_screen from "assets/images/empty_booking_screen.png";
import ExperienceCard from "../../Cards/ExperienceCard";
import useAddExperienceToLibrary from "services/travel/packages/turboEngine/Mutations/useAddExperienceToLibrary";
import { DeleteOutlined, StarOutlined } from "@ant-design/icons";
import { PACKAGE_LIBRARY_ITEMS_TYPES } from "constants/PACKAGE_TYPES";
import SelectItemType from "../../SelectItemType";

const TurboEngineExperiencesModal = ({ tripId, onCancel, onUpdate }) => {
  const [form] = useForm();
  ...
  const turboEngineExperiences = useGetTurboEngineExperiences(
    {
      ...
      {activeStep === 1 ? (
        ...
        <>
          ...
          <div className="search_engine_block">
            ...
            <Form form={form} onSubmitCapture={() => turboEngineExperiences.refetch()}>
              <Row gutter={[12, 12]}>
                <Col span={21}>
                  <Form.Item
                    name={"location"}
          ...
          <div className="search_engine_results">
                  ...
                  <div
                    ...
                    <Flex align="center" justify="space-between" gap={8}>
                      ...
                      <Space>
                        ...
                        <Tooltip title={experience?.isDefault ? "Default" : "Set as default"}>
                          <Button
                            icon={<StarOutlined />}
                            className="table_action_button"
            ...
            {!turboEngineExperiences?.data ||
            !Array.isArray(turboEngineExperiences?.data) ||
            turboEngineExperiences?.data?.length === 0 ? (
              <Empty
                style={{
                  height: "100%",
                  display: "flex",
              ...
              <>
                {turboEngineExperiences?.data?.map((experience, index) => (
                  <ExperienceCard
                    key={index}
...
export default TurboEngineExperiencesModal;
