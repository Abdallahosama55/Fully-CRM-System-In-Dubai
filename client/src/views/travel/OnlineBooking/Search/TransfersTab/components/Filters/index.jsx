              ...
              items={[
                {
                  ...
                  children: (
                    <div className="transfer_filters_checkbox_group">
                      <Checkbox.Group
                        value={types}
                        onChange={(values) => {
                          setTypes(values);
                        ...
                        {vehicleTypes?.data?.map((type) => (
                          <p
                            ...
                            className={`checkbox_item ${
                              type?.icon ? "checkbox_item_with_icon" : ""
                            }`}>
                            <Checkbox value={type?.id}>
                              {type?.icon && type?.icon.includes("<svg") ? (
                                <SvgImage svgContent={type?.icon} />
                              ) : (
                                ""
                              )}
                              {type?.name}
                  ...
                  children: (
                    <div className="transfer_filters_checkbox_group">
                      <Checkbox.Group
                        ...
                        className="transfer_filters_checkbox_group">
                        {vehicleBrands?.data?.map((brand) => (
                          <p key={brand.id} className="checkbox_item">
