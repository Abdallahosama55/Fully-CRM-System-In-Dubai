...
import useGetSearchCharter from "services/travel/charters/Queries/useGetSearchCharter";
...
const CharterTab = ({ setTabContent }) => {
  const [form] = useForm();
  ...
  const flightsList = useGetSearchCharter(
    {
      ...search,  
      fromDate:
        search?.type === "TWO_WAY"
