...
import "./styles.css";
import { Button, Flex, Typography, Table } from "antd";
import PersonSVG from "assets/jsx-svg/PersonSVG";
import { ChildFaceSVG } from "assets/jsx-svg";
import dayjs from "dayjs";

const TboRoomsSection = ({ rooms, onAddToTrip = () => {}, loadingRoomId, setLoadingRoomId }) => {
  return (
    <div>
            ...
            <Flex align="center" justify="space-between">
              ...
              <Flex align="center" gap={10}>
                ...
                <Button
                  size="small"
                  type="primary"
                  loading={loadingRoomId === room?.BookingCode}
                  onClick={() => {
                    setLoadingRoomId(room?.BookingCode);
                    onAddToTrip({
                      name: room?.Name?.[0],
                      ...
                      rooms: room?.Name?.map((el, index) => {
                        return {
                          ...
                          price: room?.DayRates?.[index]?.[0]?.BasePrice,
                        };
                      }),
                    });
                  }}>
