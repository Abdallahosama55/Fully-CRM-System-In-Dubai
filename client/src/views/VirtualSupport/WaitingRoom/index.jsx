...
export default function WaitingRoom({ setActiveBtn, meetingSettings, changeSettings }) {
  ...
  const admitAll = () => {
    Object.entries(meetingSettings?.waitingList)
    ...
    <section>
      ...
      {waitingRoomUsersLength === 0 ? (
        <Row style={{ marginTop: "1rem" }}>
          <Typography.Text className="fw-600">There Are No Waiting Users</Typography.Text>
        </Row>
      ) : (
        <>
          <Row
                        ...
                        <Row align="middle" wrap={false} gutter={[8, 0]}>
                          <Col>
                            <Button
                              ...
                              size="small"
                              className="fz-12"
                              onClick={() => changeSettings(`/waitingList/${key}`, {})}>
                              Decline
                            </Button>
                          </Col>
