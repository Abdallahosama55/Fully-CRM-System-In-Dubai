import { Button, Col, Form, Image, Input, Modal, Row, Select, Switch, Upload } from "antd";
...
export default function LinksTab({ setFormActiveTabs, data, setTabActiveKey, setData, onClose }) {
  const [form] = useForm();
