...
export default function Variation({
  ...
  return (
    <>
        ...
        <Row justify="space-between" align="top">
          <Col xs={24} xxl={6}>
            <Form.Item
              ...
              label="Product Image">
              <Upload accept="image/*" beforeUpload={beforUploadImage} multiple listType="picture">
                <Row
      ...
      <Form.Item label="3D Model" name={[enVariantName, "ownModel"]} initialValue={defualtModel}>
