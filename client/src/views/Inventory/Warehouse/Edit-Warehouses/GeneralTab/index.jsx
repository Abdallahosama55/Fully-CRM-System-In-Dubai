...
export default function GeneralTab({
  ...
  useEffect(() => {
    warehousesdata.warehouseTranslations?.forEach((lang) => {
      form.setFieldValue(`warehousesName${lang.languageCode}`, lang.name);
      ...
      form.setFieldValue(`warehousesLocation${lang.languageCode}`, lang.metaTagKeywords);
    });
  }, [warehousesdata.warehouseTranslations, form]);
