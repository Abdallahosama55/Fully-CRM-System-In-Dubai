...
// style
import './styles.css';
export default function AvatarUpload ({ onChange, setPreviewPicData,previewImg }) {
    const [previewPic, setPreviewPic] = useState(previewImg || defaultAvatar);
